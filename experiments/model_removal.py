...
def single_run(prompts, reward_source, embeddings, X, algos):
    ...
    for t in tqdm(range(1, T+1), desc="Test iterations (model removal)"):
        ...
        smap = reward_source.rewards(p, set(current + [baseline_model]))
...
if __name__ == "__main__":
    ...
    algos = ["Optimal", "Always", "Random", "PAK-UCB", "NeMoS", "KNN-UCB"]  # add "neuronal-s" if desired
